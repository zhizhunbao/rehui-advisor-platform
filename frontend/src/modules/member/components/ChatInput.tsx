    ...
    <div className="relative w-full">
      ...
      >
        <button
          ...
          className="mb-1.5 w-10 h-10 rounded-full flex items-center justify-center transition-all duration-300 bg-gradient-to-r from-purple-500 to-blue-500 text-white hover:scale-105 hover:shadow-lg disabled:opacity-50"
