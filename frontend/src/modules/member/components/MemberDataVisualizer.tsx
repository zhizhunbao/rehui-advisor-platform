// Member 数据可视化组件 - Props: data, lang
import type { ChartData, Language } from "@/common/types";

interface MemberDataVisualizerProps {
  data: ChartData;
  lang: Language;
}

const MemberDataVisualizer: React.FC<MemberDataVisualizerProps> = ({
  data,
  lang,
}) => {
  ...
  return (
    <div className="my-10 p-8 bg-slate-50/30 dark:bg-white/[0.02] border border-slate-200/50 dark:border-white/5 rounded-[2rem] animate-in">
...
export default MemberDataVisualizer;
