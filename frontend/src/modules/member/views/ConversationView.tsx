...
import type { Conversation, Language, QuotaStatus } from "@/common/types";
import MemberMessageBubble from "@/modules/member/components/MemberMessageBubble";
        ...
        <div className="w-full max-w-3xl mx-auto py-6 px-4">
          {conversation?.messages.map((msg) => (
            <MemberMessageBubble
              ...
              message={msg}
              lang={lang}
              onSuggestionClick={(q: string) => !isLoading && onSendMessage(q)}
