"""add_prompt_source_fields

Revision ID: add_prompt_source_fields_001
Revises: add_skills_table_001
Create Date: 2025-12-30

Add category, source, repo fields back to prompt_templates for external prompts.
"""
...
revision: str = "add_prompt_source_fields_001"
...
def upgrade() -> None:
    ...
    op.add_column(
        "prompt_templates",
        sa.Column("source", sa.String(100), nullable=True, server_default=""),
    )
