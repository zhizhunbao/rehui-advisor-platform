...
# Prompt 分类定义
PROMPT_CATEGORIES = [
    {"code": "job", "name": "求职就业", "name_en": "Job & Career", "icon": "Briefcase", "sort_order": 1},
    {"code": "advisor", "name": "智能顾问", "name_en": "Advisor", "icon": "MessageCircle", "sort_order": 2},
    {"code": "analysis", "name": "内容分析", "name_en": "Analysis", "icon": "Search", "sort_order": 3},
    {"code": "writing", "name": "写作助手", "name_en": "Writing", "icon": "PenTool", "sort_order": 4},
    {"code": "coding", "name": "编程助手", "name_en": "Coding", "icon": "Code", "sort_order": 5},
    {"code": "general", "name": "通用工具", "name_en": "General", "icon": "Sparkles", "sort_order": 6},
]
