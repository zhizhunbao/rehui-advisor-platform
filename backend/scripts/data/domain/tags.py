...
TAGS: List[Dict[str, Any]] = [
    ...
    {
        "code": "claude_code_skill",
        "name": "Claude Code Skill",
        "name_en": "claude code skill",
        "domain_code": "skills",
    },
    {
        "code": "rag",
...
AI_EXTRA_TAGS: List[Dict[str, Any]] = [
    ...
    {"code": "anthropic", "name": "Anthropic", "name_en": "Anthropic", "domain_code": "llm_models"},
    {"code": "xai", "name": "xAI", "name_en": "xAI", "domain_code": "llm_models"},
    {"code": "grok", "name": "Grok", "name_en": "Grok", "domain_code": "llm_models"},
    ...
    {"code": "deepseek", "name": "DeepSeek", "name_en": "DeepSeek", "domain_code": "llm_models"},
    {"code": "qwen", "name": "通义千问", "name_en": "Qwen", "domain_code": "llm_models"},
    # llm_models - 推理和部署
    ...
    # ai_coding_tools - AI 编程工具
    {"code": "claude_code", "name": "Claude Code", "name_en": "Claude Code", "domain_code": "ai_coding_tools"},
    {"code": "cursor", "name": "Cursor", "name_en": "Cursor", "domain_code": "ai_coding_tools"},
    {"code": "copilot", "name": "Copilot", "name_en": "Copilot", "domain_code": "ai_coding_tools"},
    {"code": "kiro", "name": "Kiro", "name_en": "Kiro", "domain_code": "ai_coding_tools"},
    {"code": "antigravity", "name": "Antigravity", "name_en": "Antigravity", "domain_code": "ai_coding_tools"},
    {"code": "windsurf", "name": "Windsurf", "name_en": "Windsurf", "domain_code": "ai_coding_tools"},
    {"code": "aider", "name": "Aider", "name_en": "Aider", "domain_code": "ai_coding_tools"},
    {"code": "cline", "name": "Cline", "name_en": "Cline", "domain_code": "ai_coding_tools"},
    {"code": "continue", "name": "Continue", "name_en": "Continue", "domain_code": "ai_coding_tools"},

    # agents - 国外大公司框架
    {"code": "autogen", "name": "AutoGen", "name_en": "AutoGen", "domain_code": "agents"},
    {"code": "semantic_kernel", "name": "Semantic Kernel", "name_en": "Semantic Kernel", "domain_code": "agents"},
    {"code": "openai_swarm", "name": "Swarm", "name_en": "Swarm", "domain_code": "agents"},
    {"code": "smolagents", "name": "Smolagents", "name_en": "Smolagents", "domain_code": "agents"},
    {"code": "genkit", "name": "Genkit", "name_en": "Genkit", "domain_code": "agents"},
    {"code": "bedrock_agents", "name": "Bedrock Agents", "name_en": "Bedrock Agents", "domain_code": "agents"},
    # agents - 国内大公司框架
    {"code": "joyagent", "name": "JoyAgent", "name_en": "JoyAgent", "domain_code": "agents"},
    {"code": "qwen_agent", "name": "Qwen-Agent", "name_en": "Qwen-Agent", "domain_code": "agents"},
    {"code": "agentscope", "name": "AgentScope", "name_en": "AgentScope", "domain_code": "agents"},
    {"code": "agent_universe", "name": "agentUniverse", "name_en": "agentUniverse", "domain_code": "agents"},
    # agents - 其他框架
    ...
    {"code": "chroma", "name": "Chroma", "name_en": "Chroma", "domain_code": "vector_databases"},
    {"code": "chromadb", "name": "ChromaDB", "name_en": "ChromaDB", "domain_code": "vector_databases"},
    {"code": "pinecone", "name": "Pinecone", "name_en": "Pinecone", "domain_code": "vector_databases"},
    {"code": "qdrant", "name": "Qdrant", "name_en": "Qdrant", "domain_code": "vector_databases"},
    {"code": "weaviate", "name": "Weaviate", "name_en": "Weaviate", "domain_code": "vector_databases"},
    {"code": "milvus", "name": "Milvus", "name_en": "Milvus", "domain_code": "vector_databases"},
    {"code": "pgvector", "name": "pgvector", "name_en": "pgvector", "domain_code": "vector_databases"},
    {"code": "faiss", "name": "FAISS", "name_en": "FAISS", "domain_code": "vector_databases"},
    {"code": "elasticsearch", "name": "Elasticsearch", "name_en": "Elasticsearch", "domain_code": "vector_databases"},
    
    # search_techniques - 搜索技术
    {"code": "semantic_search", "name": "语义搜索", "name_en": "Semantic Search", "domain_code": "search_techniques"},
    {"code": "hybrid_search", "name": "混合搜索", "name_en": "Hybrid Search", "domain_code": "search_techniques"},
    {"code": "reranking", "name": "重排序", "name_en": "Reranking", "domain_code": "search_techniques"},
    {"code": "bm25", "name": "BM25", "name_en": "BM25", "domain_code": "search_techniques"},
    
    # rag_frameworks - RAG 框架相关
    {"code": "document_parsing", "name": "文档解析", "name_en": "Document Parsing", "domain_code": "rag_frameworks"},
    {"code": "chunking", "name": "文本分块", "name_en": "Chunking", "domain_code": "rag_frameworks"},
    {"code": "dspy", "name": "DSPy", "name_en": "DSPy", "domain_code": "rag_frameworks"},
    {"code": "langgraph", "name": "LangGraph", "name_en": "LangGraph", "domain_code": "rag_frameworks"},
